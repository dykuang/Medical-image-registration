# -*- coding: utf-8 -*-
"""
Created on Fri Apr 13 17:02:36 2018

@author: Dongyang

test the example from mayavi
"""
...
# Extract the data
import tarfile
tar_file = tarfile.open(r'C:/Users/Dongyang/Downloads/MRbrain.tar.gz')
try:
    os.mkdir(r'C:/Users/Dongyang/Downloads/mri_data')
except:
    pass
tar_file.extractall(r'C:/Users/Dongyang/Downloads/mri_data')
tar_file.close()


### Read the data in a numpy 3D array #########################################
import numpy as np
data = np.array([np.fromfile(os.path.join(r'C:/Users/Dongyang/Downloads/mri_data', 'MRbrain.%i' % i),
